...
export const escaleraFijo = {
  ...
  descuentos: [
    { nivel: 'XS', discount: '10%', months: 12, desc: 'Descuento del 10% en servicio principal por 12 meses.', color: '#10b981' },
    { nivel: 'M', discount: '20%', months: 12, desc: 'Descuento del 20% en servicio principal por 12 meses.', color: '#f59e0b' },
    { nivel: 'XL', discount: '30%', months: 12, desc: 'Descuento del 30% en servicio principal por 12 meses.', color: '#ef4444' },
  ],
  ofertaBasica: [
